...
@if(cache()->has('message_success'))

<div class="row justify-content-center">
    <div class="alert col-md-6 alert-info alert-dismissible fade show text-center mb-5" style="">
        ...
        &nbsp;&nbsp; {{cache('message_success')}}</div>
</div>

@endif
@if(cache()->has('message_success_admin'))

<div class="alert alert-success alert-has-icon">
    <div class="alert-icon"><i class="far fa-lightbulb"></i></div>
    <div class="alert-body">
        <div class="alert-title">Success</div>
        {{cache('message_success_admin')}}
    </div>
</div>
@endif
