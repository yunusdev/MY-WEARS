...
class CartController extends BaseController
{
    ...
    public function getUserCartItems(): \Illuminate\Http\JsonResponse
    {
    ...
    public function addItemsToCart(AddItemsToCartRequest $request): \Illuminate\Http\JsonResponse
    {
        try {
            DB::beginTransaction();
